...
namespace AlphaPrefabs
{
    ...
    public static class GraphicsCache
    {
        ...
        public static readonly Graphic graphicMediumValue = (Graphic_Single)GraphicDatabase.Get<Graphic_Single>("Things/Item/AP_PrefabItem", ShaderDatabase.Cutout, Vector2.one, Color.white);
        ...
        public static readonly Graphic graphicMediumValueBuilding = (Graphic_Single)GraphicDatabase.Get<Graphic_Single>("Things/Building/AP_DeployedPrefab", ShaderDatabase.Cutout, Vector2.one * 2, Color.white);
